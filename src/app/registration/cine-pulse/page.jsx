      ...
      <section className="pt-32 pb-20 px-8">
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 text-sm">This short film competition invites participants to showcase their creativity, storytelling, and cinematic vision in max of 2 mins.</p>
          </div>
