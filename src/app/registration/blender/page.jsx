...
export default function BlastInBlenderWorkshop() {
      ...
      <section className="pt-32 pb-20 px-8 relative">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="text-6xl font-bold mb-4">BLAST IN BLENDER</h1>
            <p className="text-red-600 text-sm tracking-wider mb-4">3D MODELING & ANIMATION WORKSHOP</p>
            <p className="text-gray-500 text-sm">
              Master the art of 3D modeling and animation using Blender. Learn modeling, texturing, lighting, and rendering techniques to create stunning 3D visuals and animations.
            </p>
          </div>
