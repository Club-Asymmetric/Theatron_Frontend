...
export default function ModelingWorkshopRegistration() {
      ...
      <section className="pt-32 pb-20 px-8 relative">
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-6xl font-bold mb-4">MODELING WORKSHOP</h1>
            <p className="text-red-600 text-sm tracking-wider mb-4">
              FASHION & CREATIVITY SESSION
            </p>
            <p className="text-gray-500 text-sm">
              Unleash your creativity in our hands-on fashion workshop — learn,
              design, and bring your style ideas to life! Explore modeling techniques,
              styling concepts, and stage presence under expert guidance.
            </p>
          </div>
