...
export default function TrailerCutRegistration() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/register/solo/trailer-cut`, {
        method: 'POST',
        headers: {
      ...
      <section className="pt-32 pb-20 px-8">
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 text-sm">This editing competition invites participants to showcase their creativity and technical skills through video crafting and refinement.</p>
          </div>
          ...
          <div className="border border-gray-700 p-8">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              >
                {isSubmitting ? 'SUBMITTING...' : 'REGISTER FOR TRAILER CUT'}
              </button>
            </form>
          </div>
        </div>
