...
export default function ScriptWritingRegistration() {
  ...
  const handlePayment = async (e) => {
    ...
    try {
      const params = new URLSearchParams({
        ...
        amount: 150,
        currency: "INR",
        receipt: `scriptwriting_${Date.now()}`,
      ...
      <section className="pt-32 pb-20 px-8 relative">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="text-6xl font-bold mb-4">SCRIPT WRITING</h1>
            <p className="text-red-600 text-sm tracking-wider mb-4">CREATIVE STORYTELLING WORKSHOP</p>
            <p className="text-gray-500 text-sm">
              Learn how to transform your imagination into powerful scripts. Master storytelling, dialogue, and screenplay techniques guided by industry mentors.
            </p>
          </div>
