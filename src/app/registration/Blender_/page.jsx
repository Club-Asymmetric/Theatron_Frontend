    ...
    <main className="bg-black text-white min-h-screen relative">
      ...
      <section className="pt-32 pb-20 px-8 relative">
        <div className="max-w-2xl mx-auto text-center">
          <h1 className="text-6xl font-bold mb-4">Blender Workshop</h1>
          ...
          <div className="border border-gray-700 p-10 rounded-lg bg-gray-900 shadow-lg">
            ...
            <p className="text-gray-400">
              Registrations for the <span className="text-white font-semibold">Blender Workshop</span> are now closed.
              <br />
