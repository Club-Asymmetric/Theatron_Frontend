...
export default function StillsOfSoulRegistration() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/register/solo/stills-of-soul`, {
        method: 'POST',
        headers: {
      ...
      <section className="pt-32 pb-20 px-8">
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 text-sm">Showcase your creativity and photography skills by submitting your most captivating original photo.</p>
          </div>
          ...
          <div className="border border-gray-700 p-8">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              >
                {isSubmitting ? 'SUBMITTING...' : 'REGISTER FOR STILLS OF SOUL'}
              </button>
            </form>
          </div>
        </div>
