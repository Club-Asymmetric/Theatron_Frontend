  ...
  return (
    <div className="fixed left-8 top-1/2 transform -translate-y-1/2 z-40">
      ...
      <div className="relative group">
        {/* Main Instagram Icon */}
        <a
          href="https://www.instagram.com/immerse_cit?igsh=bmpiOWtmM29xcXZn"
          target="_blank"
        ...
        {/* Hover pop-up image */}
        <div className="absolute left-full top-1/2 transform -translate-y-1/2 ml-3 hidden group-hover:flex">
          <img
